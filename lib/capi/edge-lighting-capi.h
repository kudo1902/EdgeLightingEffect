...
#define EL_API __attribute__((visibility("default")))
    ...
    EL_API el_result_e el_effect_get_geometry(const el_effect_handle_t *fx,
    ...
    EL_API el_result_e el_effect_set_wireframe_color(el_effect_handle_t *fx,
                                                     float r, float g, float b, float a);
    EL_API el_result_e el_effect_get_wireframe_color(const el_effect_handle_t *fx,
                                                     float *outR, float *outG, float *outB, float *outA);
