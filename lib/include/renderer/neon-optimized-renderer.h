...
namespace EdgeLighting
{
    ...
    private:
        ...
        /// pre-pass. Unlike NeonRenderer's, its width is runtime-tunable via
        /// @c OptimizedNeonConfig::gradientLutSize - a width change snaps
        /// instead of cross-fading (the two rings have different lengths).
